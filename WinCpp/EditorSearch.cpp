                                   ...
                                   std::string* error)
{
  ...
  if (!options.regex)
  {
    ...
    {
      SearchMatch match{};
      if (!FindPlain(text, start, start, needle, options.matchCase, options.wholeWord, true,
                     &match))
      {
        break;
      }
                                                     ...
                                                     std::string* error)
{
  ...
  if (!options.regex)
  {
    ...
    {
      SearchMatch match{};
      if (!FindPlain(text, start, start, WideToUtf8(query), options.matchCase, options.wholeWord,
                     true, &match))
      {
        break;
      }
